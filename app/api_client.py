"""Async HTTP client with throttle, backoff, and rate-limit handling."""
...
class Throttle:
    """Throttle requests with separate intervals for reads (GET) and actions (POST)."""
...
class WikiTCGClient:
    ...
    async def get_series_list(self) -> list[dict]:
        return _extract_list(await self._request("GET", "/api/series"), "series")
